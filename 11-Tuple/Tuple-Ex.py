...
def insert_tuple_inside_tuple(outer_tuple: tuple, position: int, inner_tuple: tuple) -> tuple:
    ...
    """
    outer_tuple = list(outer_tuple)
    inner_tuple = list(inner_tuple)
    outer_tuple.insert(position, inner_tuple)
...
if __name__ == "__main__":
    ...
    assert merge_tuples((1,), (3,)) == (1, 3)
    assert merge_tuples((1, 2, 3), (1, 2)) == (1, 2, 3, 1, 2)
    assert remove_odd_numbers((1, 2, 3)) == (2,)
    assert remove_odd_numbers((1, 5, 3)) == ()
    assert remove_odd_numbers((2, 4, 6)) == (2, 4, 6)
    assert insert_tuple_inside_tuple((1, 2), 0, (3, 4)) == (3, 4, 1, 2)
    assert insert_tuple_inside_tuple((1, 2), 1, (3, 4)) == (1, 3, 4, 2)
    assert insert_tuple_inside_tuple((1, 2), 2, (3, 4)) == (1, 2, 3, 4)
    assert insert_tuple_inside_tuple((1, 2, 3), 1, (1, )) == (1, 1, 2, 3)